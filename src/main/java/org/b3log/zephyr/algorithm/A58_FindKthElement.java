 ...
 */
public class A58_FindKthElement {

    private A22_ReverseLinkedList reverseLinkedList;

    public A58_FindKthElement() {
        this.reverseLinkedList = new A22_ReverseLinkedList();
    }

    public static void main(String[] args){
        ListNode<Integer> list = ListNode.createList(new int[] { 1, 2, 3 });
        ListNode<Integer> list2 = ListNode.createList(new int[] { 1, 2, 3 });
        ListNode<Integer> list3 = ListNode.createList(new int[] { 1, 2, 3 });
        A58_FindKthElement findElement=new A58_FindKthElement();
        ListNode result = findElement.find(list, 2);
        ListNode result2 = findElement.find2(list2, 1);
        ListNode result3 = findElement.find3(list3, 1);

        PrintUtil.printList(result);
        PrintUtil.printList(result2);
        PrintUtil.printList(result3);
    }
